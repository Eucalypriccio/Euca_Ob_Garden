...
*这种配置只够进行小规模的本地训练推理，建议使用免费 GPU 资源*
...
* `jupyter notebook --notebook-dir "D:\MLFS\jupyter_notebook"`
...
  #  Default: ''
  c.ServerApp.root_dir = 'D:\MLFS\jupyter_notebook'
  ```

注意：使用 Jupyter Lab 需要注意这一部分，在 VS Code 中编写 Jupyer Notebook 可以忽略
## 在 VS Code 中配置解释器路径

* `Ctrl+Shift+P` 打开命令面板
* Python：选择解释器
* 选择对应的路径，如 `D:\Anaconda\envs\edwardpytorch\python.exe`
